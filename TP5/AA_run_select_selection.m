function run_tests()
  ...
  selection_algorithms(2).func = @rank;
  selection_algorithms(2).name = 'rank';
  ...
  selection_algorithms(7).func = @(x, y, z)(mix1(x, y, 0.3*y));
  selection_algorithms(7).name = 'mix roulette + 30% elite';
  selection_algorithms(8).func = @(x, y, z)(mix1(x, y, 0.7*y));
  selection_algorithms(8).name = 'mix roulette + 70% elite';
  selection_algorithms(9).func = @(x, y, z)(mix2(x, y, 0.3*y));
  selection_algorithms(9).name = 'mix stochastic + 30% elite';
  selection_algorithms(10).func = @(x, y, z)(mix2(x, y, 0.7*y));
  ...
  generations_200 = generation_limit(2);
          ...
          for i5 = selection_2_target
            ...
            for i6 = 1:size(mutation_algorithms, 2)
              ...
              for i7 = 1:size(cross_algorithms, 2)
                ...
                save(['resultado_' datestr(now,30) '.mat'], 'data');
