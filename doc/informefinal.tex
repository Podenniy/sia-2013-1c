...
\subsection{Búsquedas informadas}
    ...
    La columna \textbf{Peor} cuenta la cantidad de casos que el \textit{Greedy} con esa heurística dio un peor resultado que \textit{DFS}. De la misma manera, \textbf{Igual} y \textbf{Mejor} muestran respectivamente cuantas veces expandieron la misma cantidad de nodos y cuántas veces el \textif{Greedy} expandió menos nodos.
